...
def launch_setup(context, *args, **kwargs):
    ...
    package_description = "hive_description"
    robot_desc_path = os.path.join(get_package_share_directory(package_description), "urdf", robot_file)
...
def generate_launch_description():
    ...
    robot_file_arg = DeclareLaunchArgument('robot_file', default_value='geunwoo.xacro')
